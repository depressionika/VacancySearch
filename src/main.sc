...
theme: / 
    ...
    state: GetCity
        ...
        go!: 
        intent: /jobSearchProfession-yes_usersays_ru || toState = "/GetProfession"
        event: noMatch || toState = "./"
    ...
    state: GetProfession
        ...
        intent: /jobSearchProfession-yes_usersays_ru || toState = "./"
        intent: /Зарплата || toState = "/SearchVacancies"
        event: noMatch || toState = "./"
